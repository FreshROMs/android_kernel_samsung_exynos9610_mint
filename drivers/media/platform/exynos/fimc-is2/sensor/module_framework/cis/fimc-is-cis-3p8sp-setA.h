...
const struct sensor_pll_info_compact sensor_3p8sp_pllinfo_A_full_30fps = {
...
const struct sensor_pll_info_compact sensor_3p8sp_pllinfo_A_2binning_30fps = {
	EXT_CLK_Mhz * 1000 * 1000, /* ext_clk */
	1456 * 1000 * 1000, /* mipi_datarate */
	559620000, /* pclk  = VT pix CLK */
...
const struct sensor_pll_info_compact sensor_3p8sp_pllinfo_A_2binning_60fps = {
	EXT_CLK_Mhz * 1000 * 1000, /* ext_clk */
	1456 * 1000 * 1000, /* mipi_datarate */
	559620000, /* pclk  = VT pix CLK */
	0x071E, /* frame_length_lines */
...
static const struct sensor_pll_info_compact *sensor_3p8sp_pllinfos_A[] = {
	/* remosaic */
	&sensor_3p8sp_pllinfo_A_full_30fps,
	&sensor_3p8sp_pllinfo_A_full_30fps,
	&sensor_3p8sp_pllinfo_A_full_30fps,
	&sensor_3p8sp_pllinfo_A_full_30fps,
	/* 68' remosaic */
	...
	&sensor_3p8sp_pllinfo_A_full_30fps,
	/* 2binning */
	&sensor_3p8sp_pllinfo_A_2binning_30fps,
	&sensor_3p8sp_pllinfo_A_2binning_30fps,
	&sensor_3p8sp_pllinfo_A_2binning_30fps,
	&sensor_3p8sp_pllinfo_A_2binning_30fps,
	/* 68' 2binning */
	...
	&sensor_3p8sp_pllinfo_A_2binning_30fps,
	/* fast ae */
	&sensor_3p8sp_pllinfo_A_2binning_60fps,
};
#endif
